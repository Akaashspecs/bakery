...
const Header = () => {
  ...
  return (
    <div className="bg-amber-100 h-[120px] rounded-b-2xl shadow-xl w-full flex lg:justify-around items-center justify-between px-5 lg:pr-0">
      {/* <div className="text-3xl font-bold text-amber-800"></div> */}
      <img src="/bakery-logo.png" alt="logo" className="h-[120px] w-[120px]" />

      <li className=" gap-5  text-2xl font-semibold text-amber-800 justify-center items-center hidden  lg:flex">
      ...
      {showMenu && (
        <div
          ref={menuRef}
          className="absolute z-50 top-[120px] right-5 bg-white  shadow-lg  flex w-[200px] flex-col items-center border lg:hidden rounded-2xl"
        >
